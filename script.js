...
const Views = {
  ...
  async intro2() {
    return Layouts.messageWithButtons({
      content: `
        <h1>You want to connect .</h1>
        <p>Talk 2Me connects you to new friends and anyone next to you.</p>
      `,
      btn: {
        text: 'What else?'
      }
  ...
  async intro3() {
    return Layouts.messageWithButtons({
      content: `
        <h1>Talk 2Me</h1>
        <p>Also <em>generating random messages </em> to help in your mission.</p>
        <p>Connect like never before by.... .</p>
      `,
      btn: {
        text: 'Clicking here'
      }
  ...
  async intro4() {
    return Layouts.messageWithButtons({
      content: `
        <h1>Linkin you up easily</h1>
        <p>This valentines is for you.</p>
